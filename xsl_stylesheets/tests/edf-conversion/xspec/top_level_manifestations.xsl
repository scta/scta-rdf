      ...
      <x:scenario>
         ...
         <x:call template="top_level_manifestation">
            ...
            <x:param name="author-uri">
               <__x:value-of select="doc('/Users/jcwitt/Projects/scta/scta-projectfiles/pg-projectdata.xml')//header/authorUri"/>
            </x:param>
            <x:param name="top-level-witnesses">
               <__x:value-of select="document('/Users/jcwitt/Projects/scta/scta-projectfiles/pg-projectdata.xml')/listofFileNames/header/hasWitnesses//witness"/>
            </x:param>
         </x:call>
         <xsl:variable name="x:result" as="item()*">
            <xsl:variable name="cid-doc" as="document-node()">
               <xsl:document>
                  <xsl:text>TeST</xsl:text>
               </xsl:document>
            </xsl:variable>
            <xsl:variable name="cid" select="$cid-doc/node()"/>
            <xsl:variable name="author-uri-doc" as="document-node()">
               <xsl:document>
                  <__x:value-of select="doc('/Users/jcwitt/Projects/scta/scta-projectfiles/pg-projectdata.xml')//header/authorUri"/>
               </xsl:document>
            </xsl:variable>
            <xsl:variable name="author-uri" select="$author-uri-doc/node()"/>
            <xsl:variable name="top-level-witnesses-doc" as="document-node()">
               <xsl:document>
                  <__x:value-of select="document('/Users/jcwitt/Projects/scta/scta-projectfiles/pg-projectdata.xml')/listofFileNames/header/hasWitnesses//witness"/>
               </xsl:document>
            </xsl:variable>
            <xsl:variable name="top-level-witnesses" select="$top-level-witnesses-doc/node()"/>
