...
# # run bible extraction here from separate file if desired
	...
	bin/rdfPassiveRelations.sh
	#echo "Begin Passive Relationships Metadata extraction";
 	#axon "-s:$base/xsl_stylesheets/rdf_relations_conversion.xsl" "-xsl:$base/xsl_stylesheets/rdf_relations_conversion.xsl" "-o:$base/relations/relations.rdf";
	echo "All finished";
